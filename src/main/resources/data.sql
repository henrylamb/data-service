...
(8, 'Marketing', 'Marketing Specialist', CURRENT_TIMESTAMP, NULL, 'Marketing Specialist', 'Assist in marketing campaigns.', 'Experience in digital marketing preferred.', 'open', 'Mid-level', 'resume2.pdf', 'cover_letter2.pdf'),
(8, 'Sales', 'Sales Associate', CURRENT_TIMESTAMP, NULL, 'Sales Associate', 'Manage customer accounts and sales.', 'Strong communication skills required.', 'open', 'Entry-level', 'resume3.pdf', 'cover_letter3.pdf');
